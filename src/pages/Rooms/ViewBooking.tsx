...
import { API_ROOM_DELETE, API_ROOM_GET, API_VIEW_ROOM } from '../../utils/APIConstant';
...
const RoomBooking: React.FC = () => {
    ...
    const { data: roomData } = useQuery({
        queryKey: ["get-room-booking-view"],
        queryFn: () =>
            Apiservice.getAuth(`${API_VIEW_ROOM}/${param.roomId}/bookings`, token ?? ""),
        staleTime: 5 * 60 * 1000,
    });
    ...
    return (
        <>
            <div className="flex justify-between items-start sm:items-center mb-6 gap-3 flex-col sm:flex-row">
                <Breadcrumb pageName="Room Booking" />
            </div>
