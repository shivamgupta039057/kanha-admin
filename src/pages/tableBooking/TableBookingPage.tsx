...
import { API_BANQUET_DELETE, API_BANQUET_GET, API_DELETE_GALLERY, API_DELETE_MENU, API_GET_ALL_MENU, API_GET_GALLERY, API_GET_MENU, API_ROOM_DELETE, API_ROOM_GET } from '../../utils/APIConstant';
...
console.log("openModalopenModalopenModal" , openModal);
  ...
  const { data: roomData } = useQuery({
    ...
    queryFn: () =>
      Apiservice.getAuth(`${API_GET_MENU}`, token ?? ""),
    staleTime: 5 * 60 * 1000,
  });
