...
import AddRoomsRegistration from './AddGalleryModal';
import { useMutation, useQuery, useQueryClient } from '@tanstack/react-query';
import { API_BANQUET_DELETE, API_BANQUET_GET, API_DELETE_GALLERY, API_GET_GALLERY, API_ROOM_DELETE, API_ROOM_GET } from '../../utils/APIConstant';
...
console.log("openModalopenModalopenModal" , openModal);
  ...
  const { data: roomData } = useQuery({
    queryKey: ["get-gallery-list"],
    queryFn: () =>
      Apiservice.getAuth(`${API_GET_GALLERY}`, token ?? ""),
    staleTime: 5 * 60 * 1000,
  });
